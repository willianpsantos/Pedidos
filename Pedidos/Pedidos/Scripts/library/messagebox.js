(function ($, undefined) {
        ...
        MessageBox = Window.extend({
            ...
            _renderActions: function () {
                ...
                if (options.buttons && options.buttons.items && options.buttons.items.length > 0) {
                    ...
                    for (key in options.buttons.items) {
    ...
    window.MessageBox = {        
        OK: {
            name: 'ok',
            iconCls: 'fa fa-thumbs-up fa-lg green'
        },

        YES: {
            name: 'yes',
            iconCls: 'fa fa-check-circle fa-lg green'
        },

        NO: {
            name: 'no',
            iconCls: 'fa fa-times-circle fa-lg red'
        },

        CANCEL: {
            name: 'cancel',
            iconCls: 'fa fa-ban fa-lg red'
        },
